...
def initial_state(set_num):
    # declare and initialize the 10 set of initial state
...
if __name__ == '__main__':
    while True:
        ...
        if set_number == -1:
            ...
            puzzleGame = Puzzle(initial_state(set_number), g_state)
